#!/usr/bin/env python3
"""
Basic Flask app with user login emulation and
i18n support, including timezone handling
"""
...
def index():
    """
    Index route that renders the welcome message based on user login status.
    """
